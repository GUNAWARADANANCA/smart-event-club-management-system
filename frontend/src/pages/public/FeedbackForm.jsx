    ...
    return (
      <div className="min-h-[80vh] bg-white font-sans rounded-3xl overflow-hidden relative p-8 flex items-center justify-center">
        ...
        <div className="w-full max-w-md relative z-10 text-center">
          <Card
            variant="outlined"
            className="border border-[#C8E6C9] shadow-xl shadow-green-900/5 rounded-3xl overflow-hidden p-12 bg-white"
          >
            ...
            <p className="text-slate-600 mb-8">
              Thank you for sharing your thoughts. Your feedback helps us build a
        ...
        >
          <div className="text-center mb-10">
            ...
            <p className="text-slate-600 font-medium">
              Help us improve your experience by providing your honest feedback
              and rating.
            </p>
          </div>
          ...
          >
            <Form.Item
              name="name"
              label={
                <span className="text-slate-800 font-bold tracking-wide uppercase text-sm">
                  Your Name
                </span>
              }
            >
              <Input
                ...
                className="border-[#C8E6C9] rounded-xl"
              />
            </Form.Item>
            ...
            >
              <Rate
                ...
                className="text-4xl text-[#4CAF50]"
            ...
            >
              <Radio.Group className="w-full feedback-category-options">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                  {["General", "Bug Report", "Feature Request", "UI/UX"].map(
                    (cat) => (
                      <Radio.Button
                        key={cat}
                        value={cat}
            ...
            >
              <Input
                ...
                className="border-[#C8E6C9] text-slate-900 rounded-xl px-4 py-3 font-medium"
            ...
            >
              <TextArea
                ...
                className="border-[#C8E6C9] text-slate-900 rounded-xl p-4 text-base resize-none font-medium"
                style={{ background: "#FFFFFF", color: "#0f172a" }}
              />
            </Form.Item>
            ...
            <Form.Item className="mt-8 mb-0">
              <Button
                ...
                className="w-full h-14 bg-gradient-to-r from-[#43A047] to-[#4CAF50] border-0 rounded-xl text-lg font-bold tracking-wider shadow-lg shadow-green-600/20 text-white"
              >
                SUBMIT FEEDBACK
              </Button>
            </Form.Item>
