    ...
    <div className="min-h-screen font-sans flex items-center justify-center p-4 relative overflow-hidden" style={{ background: '#0F172A' }}>
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-black text-white uppercase tracking-wider mb-2">Event Secure</h1>
          <p className="text-slate-400 text-sm font-medium">Event Management Authentication</p>
        </div>
